...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(c -> c
            ...
            .requestMatchers(POST, "/reviews").hasAnyRole("USER_PROVA", "USER_BASIC", "USER_PRO")
            .requestMatchers("/trainings").hasAnyRole("USER_PROVA", "USER_BASIC", "USER_PRO")
            .requestMatchers("/composition").hasAnyRole("USER_PROVA", "USER_BASIC", "USER_PRO")
        ...
        // .requestMatchers(GET, "/reviews").permitAll()  // metterlo per specificare tutti gli endpoints?
