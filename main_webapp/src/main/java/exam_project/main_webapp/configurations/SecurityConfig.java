...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(c -> c
                ...
                .requestMatchers("/allenamenti").hasAnyRole("USER_PROVA", "USER_BASIC","USER_PRO")
                .requestMatchers("/upgrade").hasAnyRole("USER_PROVA", "USER_BASIC")
                .requestMatchers("/allenamentiStandard").hasAnyRole("USER_PROVA", "USER_BASIC")
                .requestMatchers("/allenamentoCustom").hasAnyRole("USER_PRO")
                .requestMatchers("/allenamentiPro").hasAnyRole("USER_PRO")
